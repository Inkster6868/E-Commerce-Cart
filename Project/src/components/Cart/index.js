...
// agar cart mai ek bhi item hai toh us hisab se rendering horhi hai . agr ek item hai toh increase decrease vala component call mardenge
const Cart = () => {
    ...
    // again we are using the same logic of toggling
    const handleModal = () => {
